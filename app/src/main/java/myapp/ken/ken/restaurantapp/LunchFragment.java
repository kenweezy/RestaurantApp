...
public class LunchFragment extends ListFragment {
  public final static String ID_EXTRA="myapp.ken.ken.restaurantapp._ID";
  Cursor model=null;
  ...
  static class RestaurantHolder {
    ...
    void populateFrom(Cursor c, RestaurantHelper helper) {
      ...
      if (helper.getType(c).equals("sit_down")) {
        icon.setImageResource(R.mipmap.ball_red);
      }
      else if (helper.getType(c).equals("take_out")) {
        icon.setImageResource(R.mipmap.ball_yellow);
      }
      else {
        icon.setImageResource(R.mipmap.ball_green);
      }
    }
  }
}