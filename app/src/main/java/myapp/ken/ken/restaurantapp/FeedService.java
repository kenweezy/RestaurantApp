...
public class FeedService extends IntentService {
  public static final String EXTRA_URL="myapp.ken.ken.restaurantapp.EXTRA_URL";
  public static final String EXTRA_MESSENGER="myapp.ken.ken.restaurantapp.EXTRA_MESSENGER";
